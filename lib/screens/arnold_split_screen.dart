...
class ArnoldSplitScreen extends StatefulWidget {
  const ArnoldSplitScreen({super.key});

  @override
  State<ArnoldSplitScreen> createState() => _ArnoldSplitScreenState();
}

class _ArnoldSplitScreenState extends State<ArnoldSplitScreen>
